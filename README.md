...
This branch is the ESP-IDF/C rewrite. MicroPython is no longer in the runtime:
the application, Klipper protocol subset, clock synchronization, board drivers,
and LVGL UI are compiled native code.
...
- ILI9341 display and XPT2046 touch via stock ESP-IDF SPI drivers
...
src/                      legacy MicroPython reference (not built)
